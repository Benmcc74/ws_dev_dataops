...
tables_config = [
    {
        ...
        "hashCol": [
            "ADDRESS_TYPE_CODE", "LINE_1", "LINE_2", "LINE_3", "LINE_4",
            "LINE_5", "COUNTRY_CODE", "POSTCODE", "PAF_STATUS", "DELETED_FLAG","SOURCE_EDIT_DATE"
        ],
        ...
        "attributes": [
            "PARTY_MDM_ID", "ADDRESS_TYPE_CODE", "LINE_1", "LINE_2", "LINE_3",
            "LINE_4", "LINE_5", "COUNTRY_CODE", "POSTCODE", "PAF_STATUS","SOURCE_EDIT_DATE",
