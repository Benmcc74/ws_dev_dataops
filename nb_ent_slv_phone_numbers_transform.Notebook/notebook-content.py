...
tables_config = [
    {
        ...
        "attribute_logic": {
            ...
            "PHONE_NUMBER": """
                CASE 
                    WHEN LENGTH(TRIM(PHONE_NUMBER)) = 0 
                        THEN NULL 
                    ELSE PHONE_NUMBER 
                END
            """,
...
def normalize_phone_rows(source_df):
    ...
    return (
            ...
            array(
                struct(
                    ...
                    when(
                        ...
                        None
                    ).otherwise(col("HOMEPHONE_LASTEDITDATEHOME")).alias("SOURCE_EDIT_DATE"),
                ...
                struct(
                    ...
                    when(
                        ...
                        None
                    ).otherwise(col("MOBILEPHONE_LASTEDITDATEMOBILE")).alias("SOURCE_EDIT_DATE"),
                ...
                struct(
                    ...
                    when(
                        ...
                        None
                    ).otherwise(col("WORKPHONE_LASTEDITDATEWORK")).alias("SOURCE_EDIT_DATE"),
        ...
        .withColumn("SOURCE_EDIT_DATE", col("phone_struct.SOURCE_EDIT_DATE"))
